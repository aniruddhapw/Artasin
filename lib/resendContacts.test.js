...
const { subscriptionFor, syncNewsletterContact } = await import("./resendContacts.js");
const { newsletterEnabled } = await import("./newsletter.js");
